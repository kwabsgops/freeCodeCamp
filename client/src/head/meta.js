...
const meta = [
  ...
  // The web app manifest and apple-touch-icon are generated by
  // gatsby-plugin-manifest; these tags cover the iOS Safari-specific
  // behaviour that the manifest alone does not provide.
